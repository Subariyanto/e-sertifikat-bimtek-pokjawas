  ...
  const renderCertificateHTMLWithImage = ({ kegiatan, template, peserta, pengaturan, nomorSertifikat, qrDataUrl }) => {
    ...
    return `
      <div style="width: ${width}; height: ${height}; position: relative; overflow: hidden; font-family: 'Times New Roman', Georgia, serif; background: #ffffff;">
        ...
        <div style="position: absolute; top: ${Math.max((template.pos_nomor_y || 34) - 16, 3)}%; left: 50%; transform: translateX(-50%); z-index: 2; text-align: center; width: 100%;">
        ...
        <!-- Diberikan Kepada -->
        <div style="position: absolute; top: ${Math.min((template.pos_nama_y || 53) - 5, (template.pos_nama_y || 53) - 5)}%; left: 50%; transform: translateX(-50%); z-index: 2; text-align: center; width: 80%;">
          <p style="font-size: ${(template.font_narasi_size || 11)}pt; color: #555; margin: 0; font-style: italic;">Diberikan Kepada:</p>
        </div>

        <!-- Nama Peserta -->
        <div style="position: absolute; top: ${template.pos_nama_y || 53}%; left: 50%; transform: translateX(-50%); z-index: 2; text-align: center; width: 85%;">
        ...
        <!-- Narasi -->
        <div style="position: absolute; top: ${template.pos_narasi_y || 56}%; left: 50%; transform: translateX(-50%); z-index: 2; text-align: center; width: 70%; line-height: 1.8;">
