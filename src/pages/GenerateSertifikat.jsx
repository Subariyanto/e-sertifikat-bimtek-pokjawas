  ...
  const renderCertificateHTMLWithImage = ({ kegiatan, template, peserta, pengaturan, nomorSertifikat, qrDataUrl }) => {
    ...
    return `
      <div style="width: ${width}; height: ${height}; position: relative; overflow: hidden; font-family: 'Times New Roman', Georgia, serif; background: #ffffff;">
        ...
        <div style="position: absolute; top: ${Math.max(42 - 16, 3)}%; left: 50%; transform: translateX(-50%); z-index: 2; text-align: center; width: 100%;">
        ...
        <!-- Diberikan Kepada -->
        <div style="position: absolute; top: ${Math.min(58 - 5, 58 - 5)}%; left: 50%; transform: translateX(-50%); z-index: 2; text-align: center; width: 80%;">
