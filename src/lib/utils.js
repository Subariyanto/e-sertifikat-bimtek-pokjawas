...
export const getNarasiDefault = (jenisSertifikat) => {
  const narasi = {
    ...
    'Narasumber': 'Diberikan kepada {{nama_peserta}} sebagai Narasumber pada kegiatan {{nama_kegiatan}} yang diselenggarakan oleh {{nama_lembaga}} pada tanggal {{tanggal_mulai}} bertempat di {{tempat}}.',
